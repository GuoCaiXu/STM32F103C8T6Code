...
# define SPI_SCK_W(x)           GPIO_WriteBit(SCK_PORT, SCK_PIN, (BitAction)x)
# define SPI_MOSI_W(x)          GPIO_WriteBit(MOSI_PORT, MOSI_PIN, (BitAction)x)
# define SPI_MISO_R()           GPIO_ReadInputDataBit(MISO_PORT, MISO_PIN)
